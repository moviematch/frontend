...
const Duration _kUnconfirmedSplashDuration = const Duration(milliseconds: 100);
const Duration _kSplashFadeDuration = const Duration(milliseconds: 300);

const double _kSplashInitialSize = 1.0; // logical pixels
const double _kSplashConfirmedVelocity = 1.4;

class FastSplashFactory extends InteractiveInkFeatureFactory {
  const FastSplashFactory();
